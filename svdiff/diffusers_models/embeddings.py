...
from svdiff.layers import SVDLinear, SVDLayerNorm
...
class TimestepEmbedding(nn.Module):
    def __init__(
        ...
        self.linear_1 = SVDLinear(in_channels, time_embed_dim)

        if cond_proj_dim is not None:
            self.cond_proj = SVDLinear(cond_proj_dim, in_channels, bias=False)
        else:
            self.cond_proj = None
        ...
        self.linear_2 = SVDLinear(time_embed_dim, time_embed_dim_out)
