...
from svdiff.diffusers_models.cross_attention import CrossAttention
...
class AttentionBlock(nn.Module):
    ...
    def __init__(
        ...
        self.proj_attn = SVDLinear(channels, channels, 1)
...
class FeedForward(nn.Module):
    ...
    def __init__(
        ...
        # project out
        self.net.append(SVDLinear(inner_dim, dim_out))
...
class GELU(nn.Module):
    ...
    def __init__(self, dim_in: int, dim_out: int, approximate: str = "none"):
        super().__init__()
        self.proj = SVDLinear(dim_in, dim_out)
...
class GEGLU(nn.Module):
    ...
    def __init__(self, dim_in: int, dim_out: int):
        super().__init__()
        self.proj = SVDLinear(dim_in, dim_out * 2)
...
class AdaGroupNorm(nn.Module):
    ...
    def __init__(
        ...
        self.linear = SVDLinear(embedding_dim, out_dim * 2)
